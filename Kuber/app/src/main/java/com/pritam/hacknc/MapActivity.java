...
public class MapActivity extends AppCompatActivity {
    ...
    private static float oldValue=10;
    private static boolean isSelected;
    private static List<Float> valueSet;
    private static float totalExpense=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //barChart.getD().setEnabled(false);
    ...
    private void setValueSet() {
        ...
        {
            valueSet.add(MainActivity.limitList.get(i));
            totalExpense+=MainActivity.limitList.get(i);
        }
        ...
        if (barChart.getData() != null &&
            ...
            for (int i=0;i<yVals2.size();i++)
            {
                if(columnIndex==i) {
                    ...
                    float newValue = oldSetValue-(changeInValue/count);
                    if(newValue<0){
                        yVals1.add(new BarEntry(i,0));
                        count=9-i;
                        changeInValue-=newValue;
                    }
                    else{
                        yVals1.add(new BarEntry(i,newValue));
                    }
    ...
    private List<Float> getListofNewValues() {
    ...
    private void setBarData() {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            yVals1.add(new BarEntry(i, (MainActivity.limitList.get(i)/totalExpense)*100));
        }
        //BarDataSet set1;
        ...
        barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                seekbarName.setText(MainActivity.limitList.get((int) e.getX())+"");
